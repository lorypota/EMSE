...
FILE_EXT_RE = re.compile(r"\b[\w\-/\\]+\.("
                         ...
                         r")\b", re.IGNORECASE)
COMMIT_KEYS = {'files', 'file', 'filename', 'filenames', 'files_changed', 'changed_files', 'patch', 'paths', 'modified_files', 'files_modified'}

def inspect_json_file(path: Path, max_bytes=5_000_000):
    report = {
        'path': str(path),
